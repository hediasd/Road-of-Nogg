...
const COMPOSITIONS: Array[Script] = [
	preload("res://src/presentation/effects/cube_placeholders/impact/CeilingCollapse.gd"),
	preload("res://src/presentation/effects/cube_placeholders/impact/GroundTeeth.gd"),
	preload("res://src/presentation/effects/cube_placeholders/impact/ExpandingShockwave.gd"),
	preload("res://src/presentation/effects/cube_placeholders/impact/Implosion.gd"),
	preload("res://src/presentation/effects/cube_placeholders/impact/RollingAvalanche.gd"),
	preload("res://src/presentation/effects/cube_placeholders/impact/StaggeredBombardment.gd"),
]
