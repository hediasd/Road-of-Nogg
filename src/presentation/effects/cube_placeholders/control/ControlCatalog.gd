## The shape and control family's six profiles as catalog rows, in the
...
const FAMILY := "control"
const COMPOSITIONS: Array[Script] = [
	preload("res://src/presentation/effects/cube_placeholders/control/RisingBarricade.gd"),
	preload("res://src/presentation/effects/cube_placeholders/control/ClosingCage.gd"),
	preload("res://src/presentation/effects/cube_placeholders/control/ClimbingCoil.gd"),
	preload("res://src/presentation/effects/cube_placeholders/control/LiftingVortex.gd"),
	preload("res://src/presentation/effects/cube_placeholders/control/ClappingSlabs.gd"),
	preload("res://src/presentation/effects/cube_placeholders/control/EncasingFrost.gd"),
]
