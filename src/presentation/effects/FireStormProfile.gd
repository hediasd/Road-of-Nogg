...
## AUTHORED dense inner column. With the mote layer below this totals 180,
## matching the ice storm's particle count and staying under MAX_LIVE_PARTICLES.
const EMBER_COLUMN_PARTICLE_AMOUNT := 140
...
const EMBER_MOTE_PARTICLE_AMOUNT := 40
...
## AUTHORED near-white hot core at the column base.
const EMBER_HOT_COLOR := Color(1.0, 0.94, 0.72, 0.85)
## AUTHORED mid-climb orange.
const EMBER_MID_COLOR := Color(1.0, 0.55, 0.16, 0.85)
## AUTHORED cooled deep red at the crown.
const EMBER_COOL_COLOR := Color(0.72, 0.16, 0.09, 0.85)
...
## AUTHORED warm floor response, a touch stronger than the ice storm's cold
## wash because firelight on ground is the reading that sells the column.
const GROUND_WASH_COLOR := Color(1.0, 0.48, 0.20, 0.20)
