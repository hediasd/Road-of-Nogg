...
##                           pre-PX-2 bug for comparison. The specimen reports
...
##
## **The project default is now the fourth entry, `native`** — PX-2 moved
...
## re-authoring every layout at a smaller base — see `implementation_plan.md`.
