## BattleSimPrototype — A simple manual demo of the battle simulation.
## Attach this to a Node in a scene and run it.
...
func _ready() -> void:
	print("\n\n")
	print("=== BATTLE SIMULATION PROTOTYPE ===")
	...
	# Set deterministic seed for consistent output
	sim.setSeed(42)
