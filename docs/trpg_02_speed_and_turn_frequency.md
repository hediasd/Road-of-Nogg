...
* **Games Following This Approach:** *Final Fantasy Tactics, Tactics Ogre: Let Us Cling Together / Reborn, Hoshigami: Ruining Blue Earth, Triangle Strategy, Grandia Series, Octopath Traveler, Dofus & Wakfu, Stella Deus: The Gate of Eternity, Wild Arms XF*
* **Detailed Variations:**
  - *FFT / Tactics Ogre:* `CT += Speed` tick accumulation; fast units hit 100 CT sooner.
...
* **Games Following This Approach:** *Shining Force Series, Treasure of the Rudras, Langrisser Series, Energy Breaker, Road of Nogg (current baseline)*
* **Detailed Variations:**
  - *Shining Force / Road of Nogg:* Round start sorts units by Agility/Speed descending; no multi-turns.

### Approach 1.5: Action Point (AP) Recovery Rate Scaling
Speed governs the quantity of Action Points (AP) recovered at turn start rather than turn frequency.
* **Games Following This Approach:** *Vanguard Bandits, Front Mission Series*
* **Detailed Variations:**
  - *Vanguard Bandits:* High Speed increases AP generation per turn, enabling more tile moves or heavy attacks.

### Not Applicable / Absent
Speed stat is absent, fixed, or has zero impact on turn scheduling or turn frequency.
* **Games:** *Disgaea Series, Into the Breach, Vandal Hearts Series, TearRing Saga & Berwick Saga, Knights in the Nightmare, Phantom Brave / Makai Kingdom, Yggdra Union, Resonance of Fate, Master of Monsters / Nectaris, Feda: Emblem of Justice*
