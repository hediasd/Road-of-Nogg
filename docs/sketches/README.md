...
| [2026-08-29-charge-aura-v2-spin-and-release.html](./2026-08-29-charge-aura-v2-spin-and-release.html) | Technique charge aura v2 | Spin, per-blade churn, and the three candidate release shapes, with the reasoning behind choosing expand-and-flatten at 1.00s. Also the release-time study: why pulling the release earlier forces the entrance to compress with it, and the rejected collapse kept on a toggle. |
