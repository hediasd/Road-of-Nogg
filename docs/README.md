...
| [Playable battle plan](./PLAYABLE_BATTLE_PLAN.md) | Implemented first-playable setup and player-control contract |
...
| [Archived plans](./archive/) | Completed or superseded implementation plans |
