...
* **Games Following This Approach:** *Triangle Strategy (TP), Octopath Traveler (BP), Resonance of Fate (Bezel Gauge)*
* **Detailed Variations:**
  - *Triangle Strategy:* Gain +1 Tactical Point (TP) per turn (max 5 TP) to cast spells/skills.
  - *Resonance of Fate:* **Bezel Points** fuel Hero Actions and absorb Scratch Damage; losing all Bezels causes panic mode.

### Approach 2.2: Fatigue & Heat Accumulation Gauges
Executing actions, taking damage, and countering builds Fatigue (FP). Overheating forces a Stun state.
* **Games Following This Approach:** *Vanguard Bandits*
* **Detailed Variations:**
  - *Vanguard Bandits:* Fatigue Points (FP) accumulate per action. Reaching 100 FP causes **Overheat Stun**, skipping turns until cooled down.
...
* **Games Following This Approach:** *Pokémon Series (Move PP & Form Transformations), Breath of Fire Series, Disgaea Series, Front Mission Series*
* **Detailed Variations:**
  ...
  - *Front Mission:* System points fuel pilot battle skills.
