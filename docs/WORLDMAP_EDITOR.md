...
wrote `""` read as walkable too. It is what the battlefield layer derives from (§20): a cell
painted with a tile the catalog calls walkable becomes `clear`, anything else `blocked`.
