...
- SPD currently determines order within each round; it does not grant extra turns or movement.
- Revisit frequency-based speed only as an explicit turn-system redesign.
