...
* **Games Following This Approach:** *Fire Emblem Series, Disgaea Series, Langrisser Series, Vandal Hearts Series, Feda: Emblem of Justice*
* **Detailed Variations:**
...
* **Games Following This Approach:** *Shining Force Series, Breath of Fire Series, Treasure of the Rudras, Energy Breaker, Dragon Quest 9, Road of Nogg (current baseline)*
* **Detailed Variations:**
...
### Approach 1.8: Real-Time Action-Oriented Clocks
Incorporates real-time cursor movement or phase clocks to dictate when actions resolve.
* **Games Following This Approach:** *Knights in the Nightmare*
* **Detailed Variations:**
...
### Approach 1.11: Active Time Battle (ATB)
Characters possess individual gauges that fill continuously over time based on speed. Once full, the character can input a command. Time may pause or continue during command selection.
* **Games Following This Approach:** *Chrono Trigger*

### Approach 1.12: 1v1 Turn Sequence
Only one ally and one enemy battle at a time, taking turns strictly back and forth or based on speed stats.
* **Games Following This Approach:** *Digimon World 3*

### Approach 1.13: Real-Time Persistent MMO
Combat occurs in real-time with no paused turn phases; attack frequency is dictated by an Attack Speed (ASPD) stat or cooldowns.
* **Games Following This Approach:** *Ragnarok Online, MapleStory*

### Not Applicable / Absent
* **Games:** *(None — all 28 analyzed games feature a primary turn flow paradigm).*
...
* **Games Following This Approach:** *Octopath Traveler, Pokémon Series (Flinch / Freeze / Sleep / Recharge)*
* **Detailed Variations:**
